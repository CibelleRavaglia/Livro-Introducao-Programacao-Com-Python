...
Para fazer essa verificação, calcule o resto da divisão do número por 2 e depois por todo
os números ímpares até o número lido. Se o resto de uma dessas divisões for igual a zero,
o número não é primo. Observe que 0 e 1 nao são primos e que 2 é o único número primo
que é par.
